    ...
    $.fn.flip = function (settings) {
        return this.each(function () {
            ...
            var revertedSettings = {
                ...
                bgColor: acceptHexColor(settings.color) || "#FFFFFF",//"#999",
                color: acceptHexColor(settings.bgColor) || "#FFFFFF",
                content: $this.html(),
            ...
            flipObj = {
                width: $this.width(),
                height: $this.height(),
                bgColor: acceptHexColor(settings.bgColor) || "#FFFFFF",
                fontSize: $this.css("font-size") || "12px",
                direction: settings.direction || "tb",
                toColor: acceptHexColor(settings.color) || "#FFFFFF", // #999
                speed: settings.speed || 500,
                top: $this.offset().top,
            ...
            var defaultStart = function () {
                return {
                    ...
                    borderLeftColor: "#FFFFFF",  // flipObj.transparent,
                    borderRightColor: "#FFFFFF",  // flipObj.transparent,
                    background: "none",
                    borderStyle: 'solid',
                    height: 0,
                    width: 0
