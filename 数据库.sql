...
CREATE TABLE `course` (
  ...
  `LevelID` int(11) DEFAULT NULL COMMENT '课程类型ID，1~5对应ABCDE类课',
  ...
  CONSTRAINT `course_ibfk_4` FOREIGN KEY (`LevelID`) REFERENCES `course_level` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of course
-- ----------------------------
INSERT INTO `course` VALUES ('1', 's', '计算方法', '5', '100', '3', '16', '4', '5', '0', '3', '0', '1', null, null, '0');
...
CREATE TABLE `teacher` (
  ...
  `OffaceAddress` varchar(255) DEFAULT NULL COMMENT '办公地址',
  `CollegeID` int(11) DEFAULT NULL,
  `DeleteStatus` int(11) NOT NULL DEFAULT '0' COMMENT '删除位：0 is 正常，1 is 已删除',
  PRIMARY KEY (`id`),
  KEY `CollegeID` (`CollegeID`),
